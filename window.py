...
class Window(Tk):
    def __init__(self, timer, user):
        ...
        self.text_area = Text(self, width=40, height=25, font=("Montserrat", 14), wrap=WORD)
    ...
    def create_widgets(self):
        ...
        self.top_label.grid(row=0, column=1, pady=2)
        self.text_area.grid(row=1, column=1, padx=(10, 10))
        self.text_area.focus_set()
        self.count_label.config(text="0 words")
        self.count_label.grid(row=2, column=1, pady=2)

    def clear_text(self):
        """
        Clears the text widget content
        """
